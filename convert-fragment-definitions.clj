...
(defn convert-file [file]
  (let [convert-data (comp (replace-attribute-text :fragment-definition :xmlns:dlm #".*" "http://org.apereo.portal.layout.dlm.config")
                           (replace-attribute-text :dlm:audience :evaluatorFactory #"jasig" "apereo"))]
  (->> file
       parse-as-zip
